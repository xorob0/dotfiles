...
export PATH=/opt/flutter/.pub-cache/bin:/usr/local/go/bin:/usr/lib/dart/bin:$ANDROID_SDK/emulator:$ANDROID_SDK/tools:$ANDROID_SDK/platform-tools:$ANDROID_STUDIO/tools:$FLUTTER_HOME/bin:$ANDROID_SDK/bin:$HOME/.yarn/bin:$DENO_INSTALL/bin:$HOME/.cargo/bin:$HOME/.bin:/usr/local/bin::$HOME/.bin:/usr/local/bin::/usr/local/sbin:/usr/local/bin:/usr/bin:/bin::$PATH
